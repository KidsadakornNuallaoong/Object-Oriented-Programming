 ...
 * DESCRIPTION: FastArrayQueue && Apply otherType
 ***************************************************************************************/
#include <iostream>
...
int main()
{
    ...
    do
    {
        ...
        case 5: // * enQueue
            cout << "[Massage] Enter element : ";
            cin >> dataF;
            Stack.enQueueFloat(dataF);

            cout << "Your float is already enter queue..." << endl;
            break;

        case 6: // * pop
            dataF = Stack.deQueueFloat();
        ...
        case 7: // * enQueue
            cout << "[Massage] Enter element : ";
            cin >> dataL;
            Stack.enQueueLong(dataL);

            cout << "Your long is already enter queue..." << endl;
            break;

        case 8: // * pop
            dataL = Stack.deQueueLong();
        ...
        case 9: // * enQueue
            cout << "[Massage] Enter element : ";
            cin >> str;
            Stack.enQueueCString((char *)str.c_str());

            cout << "Your string is already enter queue..." << endl;
            break;

        case 10: // * pop
            pStr = Stack.deQueueCString();
